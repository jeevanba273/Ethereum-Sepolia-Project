...
# wallet_address = web3.to_checksum_address("0x5c41DB360Ff70A9EA4699769888E86acF3ef2a12")
...
# def check_previous_transactions(address, num_blocks=20):  # Increased to 20 blocks
